...
which requires knowing the age of decedentsand an estimate of the population
exposed to risk in the same age classes. Female fertility rates, $m(a)$, are
...
fertility, but also to a lesser degree migration and attrition.
...
generations appear at the bottom of the pyramid, and move up one class per year.
