...
\citet{vaupel2014stable} expands on how to make chronological and
thanatological age structure commensurate under a constant growth rate, $r$.

This result provides a standard on which to compare chronological and thanatological age structure. It bears repeating that lifetable-derived thanatological age structure is probabilistic until after death, since it refers to the future according to an assumed mortality pattern.
