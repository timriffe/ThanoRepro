...
the same intrinsic growth rate, $r$, as Lotka's chronological renewal model if
...
b(a) &= f(a)c(a)
\end{align}
Replacing $f^\star (y)$ with the full expanded expression and
plugging into the thanatological renewal equation gives:
\begin{align}
=& \int _{y=0}^\infty \int
_{a=0}^\infty d(a+y)e^{-ra} \frac{\frac{\int_{a=0}^\infty
f(a)l(a)e^{-ra}\mu(a+y)\frac{l(a+y)}{l(a)} \dd a}{\int l(a) e^{-ra} \dd
a}}{\frac{\int_{a=0}^\infty l(a)e^{-ra} \mu(a+y)\frac{l(a+y)}{l(a)} \dd a}{\int l(a) e^{-ra} \dd a}} \dd a \dd y
\intertext{The denominator of $c(a)$ cancels out:}
=& \int _{y=0}^\infty \int
_{a=0}^\infty d(a+y)e^{-ra} \frac{
\int_{a=0}^\infty
f(a)l(a)e^{-ra}\mu(a+y)\frac{l(a+y)}{l(a)} \dd a}{
\int_{a=0}^\infty l(a)e^{-ra} \mu(a+y)\frac{l(a+y)}{l(a)} \dd a} \dd a \dd y
\intertext{Some $l(a)$'s also cancel out:}
=& \int _{y=0}^\infty \int
_{a=0}^\infty d(a+y)e^{-ra} \frac{
\int_{a=0}^\infty
f(a)e^{-ra}\mu(a+y)l(a+y) \dd a}{
\int_{a=0}^\infty e^{-ra} \mu(a+y)l(a+y) \dd a} \dd a \dd y
\intertext{Now $d(a+y) = \mu (a+y)l(a+y)$, so we can cancel the inner integral
with the denominator:}
=& \int _{y=0}^\infty 
\int_{a=0}^\infty
f(a)e^{-ra}\mu(a+y)l(a+y) \dd a \dd y
\intertext{Note also that $l(a) = \int _{x=a}^\infty d(x) \dd x$ (present
