...
\citet{miller2001increasing} or \citet{lee2002approach}, which uses lifetables
and aggregated population counts to redistribute counts within age-classes over
...
gives the probability of dying at some age $y$ years in the future, given survival to some earlier age, $a$. For age 0 this probability is simply the $d(a)$ column of the lifetable, standardized to sum to 1. For higher ages, we simply condition on survival:
