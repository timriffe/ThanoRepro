...
Fertility rates by remaining lifetime is different in this respect because death
dates can not be registered on birth certificates in the way that
maternal age or birth year can; Death timing is only knowable retrospectively or probabilistically. Since
it is difficult to imagine what a fertility schedule might look like when
classified by remaining years of life, I give two examples, first of empirically
tabulated years-left female fertiltiy rates, and second rates derived
probabilistically using a lifetable. Empirical years-left fertility rates refer
to the


 Under
a set of simple assumptions, the same lifetable used to estimate $\ell(a)$ can be used to partition and recombine counts observed by age into estimates classified by years of life left. Our objective is then to estimate a population structure component, similar to $\ell(a)e^{-ra}$, and a fertility component
...
%\subsection{Years-left fertility rates.}
%Any age-classified can be reclassified as in
